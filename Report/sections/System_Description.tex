...
In this sections we describe the conceptual model for the fuel station. In appendix A all the individual conceptual models can be found. These models are evaluated and the best model is chosen from them and described below in figure \ref{fig:concepmodel}.
